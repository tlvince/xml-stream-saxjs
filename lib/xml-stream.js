...
module.exports = class XmlStream {
  constructor(stream, encoding) {
    events.EventEmitter.call(this);
    this.super_ = events.EventEmitter;
    this.prototype = Object.create(events.EventEmitter.prototype, {
      constructor: {
        value: this,
        enumerable: false,
      },
...
function parse() {
  var self = this;
  var xml;
  if (jsEnv.isNode) xml = new expat.Parser('utf-8');
  if (jsEnv.isBrowser) xml = sax.createStream(true)
  this._parser = xml;
  this._suspended = false;
  var stack = [];
  var trace = {};
  ...
  var startTagHandler = function(name, attr) {
